<template>
  <div>
    ...
    <ItemsList
      :is-list="toggle_displaying === 'list'"
      :list="list"
    />
  </div>
</template>
...
import ListViewButtons from '@/components/list/DisplayingButtons.vue'
export default @Component({
  name: 'my-ads',
  components: { ItemsList, ListViewButtons },
  data () {
    return {
  ...
  methods: {
    changeView (value) {
      this.toggle_displaying = value
    }
  }
})

class MyAds extends Vue {
}
</script>
